...
export default class External {
    ...
    doGetNetWorks(params) {
        var json = {};
        $.ajax({
            type : 'get',
            url : '/pkgcloud/getNetWorks',
            data :params,
            dataType : 'json',
            async: false,
            success : function(data) {
    ...
    doGetMenuImageUrl(menuId) {
        var url ='/app/menuImages/cpu.png';
        return url;
    }
