    ...
    render() {
        ...
        return (
            <Modal open={this.props.show} onClose={()=>this.props.onHide()}>
                ...
                <Modal.Actions>
                    <CancelButton onClick={this.onDeny.bind(this)} content="否" disabled={this.state.loading} />
                    <ApproveButton onClick={this.onApprove.bind(this)} content="是" icon="doctor" color="green" disabled={this.state.loading} />
                </Modal.Actions>
            </Modal>
        )
    }
