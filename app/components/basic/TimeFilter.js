        ...
        return (
            <Popup  basic={true} hoverable={false} flowing open={this.state.isOpen}>
                                        ...
                                        <Table.Body>
                                            <Table.Row>
                                                ...
                                                <Table.Cell collapsing>
                                                    <Button onClick={this._handleOptimizeButtonClick.bind(this)} content='最优化' icon='refresh'/>
                                                </Table.Cell>
                                            </Table.Row>
                                        </Table.Body>
                                    </Table>
                ...
                <div className='rightFloated top-padded-10'>
                    <Button onClick={this._handleResetButtonClick.bind(this)} content="重置" icon="undo" disabled={!this.state.dirty}/>
                    <CancelButton onClick={this._handleCancelButtonClick.bind(this)} className='cancel' content="取消"  />
                    <ApproveButton onClick={this._handleApplyButtonClick.bind(this)} content='应用' positive />
                </div>
            </Popup>
        );
    }
