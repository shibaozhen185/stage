            ...
            this.props.data.items.map((item) => {
                return (
                    <Grid.Column key={item.id}>
                        ...
                        <DataSegment.Item selected={item.isSelected} onClick={(event)=>{event.stopPropagation();
						this.props.onSelect(item)}} className="fullHeight">
                            <Grid className="contentBlock">
                                ...
                                <Grid.Row className="noPadded">
                                    <Grid.Column width="4"><h5 className="ui icon header">创建时间</h5></Grid.Column>
                                    <Grid.Column width="12">{item.created_at}</Grid.Column>
                                </Grid.Row>

                                <Grid.Row className="noPadded">
                                    <Grid.Column width="4"><h5 className="ui icon header">更新时间</h5></Grid.Column>
