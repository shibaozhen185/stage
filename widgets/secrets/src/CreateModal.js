...
export default class CreateModal extends React.Component {
    ...
    _createSecret() {
        ...
        if (_.isEmpty(this.state.secretKey)) {
            errors['secretKey'] = '请提供私钥';
        }

        if (_.isEmpty(this.state.secretValue)) {
            errors['secretValue'] = '请提供公钥';
        }
