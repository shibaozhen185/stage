        ...
        return (
            <div>
                ...
                <DataTable fetchData={this.fetchGridData.bind(this)}
                    ...
                    <DataTable.Column label="键" name="key" width="20%" />
                    <DataTable.Column label="值" width="20%" />
                    <DataTable.Column label="创建时间" name="created_at" width="10%" />
                    <DataTable.Column label="更新时间" name="updated_at" width="10%" />
                        ...
                        data.items.map((secret)=>{
                            return (
                                <DataTable.Row key={secret.key}>
                                            ...
                                            this.state.showSecretKey === secret.key
                                                ? this.state.showSecretLoading
                                                    ...
                                                    : <div>
                                                        ...
                                                        <Icon bordered link name="hide" title="隐藏密钥" onClick={this._onHideSecret.bind(this)} />
                                                      </div>
                                                : <Icon bordered link name="unhide" title="展示密钥" onClick={this._onShowSecret.bind(this, secret)} />
                                        }
                                    </DataTable.Data>
                                    ...
                                    <DataTable.Data className="center aligned rowActions">
                                        <Icon bordered link name="edit" title="更新密钥" onClick={this._onUpdateSecret.bind(this, secret)} />
                                        <Icon bordered link name="trash" title="删除密钥" onClick={this._onDeleteSecret.bind(this, secret)} />
                                    </DataTable.Data>
                                </DataTable.Row>
                            );
                        })
