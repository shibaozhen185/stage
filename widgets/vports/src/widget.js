...
import VportsTable from './VportsTable';

Stage.defineWidget({
    id: 'vports',
    name: '端口管理',
    description: '显示VIM端口信息',
    initialWidth: 5,
    initialHeight: 16,
    color: 'blue',
    isReact: true,
    ...
    fetchData: function fetchData(widget, toolbox, params) {
        ...
        return toolbox.getManager().doGet(url).then(function (data) {
            ...
            // }
            // pp.authUrl = url;
            // let result = toolbox.getManager().getPorts(pp);
            // return result;
        });
    },
    ...
    render: function(widget, data, error, toolbox) {
        ...
        return (
            <VportsTable widget={widget} data={formattedData} toolbox={toolbox}/>
        );
