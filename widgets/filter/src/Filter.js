            ...
            <div>
                ...
                <Form size="small">
                    <Form.Group inline widths='equal'>
                        <Form.Field>
                            <Form.Dropdown search selection value={this.props.data.blueprintId || ''} placeholder="选择模版" fluid
                                           options={blueprintOptions} onChange={this._selectBlueprint.bind(this)} id="blueprintFilterField"/>
                        </Form.Field>
                        <Form.Field>
                            <Form.Dropdown search selection value={this.props.data.deploymentId || ''} placeholder="选择部署" fluid
                        ...
                        }
                        {
                            ...
                            <Form.Field>
                                <Form.Dropdown search selection value={this.props.data.nodeInstanceId || ''} placeholder="选择节点实例" fluid
                        ...
                        }
                        {
                            ...
                            <Form.Field>
                                <Form.Dropdown search selection value={this.props.data.executionId || ''} placeholder="选择执行" fluid
