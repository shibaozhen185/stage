        ...
        return (
            <div>
                ...
                <DataTable fetchData={this.fetchGridData.bind(this)}
                    ...
                    <DataTable.Column label="名称" name="id" width="15%"
                                      show={fieldsToShow.indexOf('Name') >= 0}/>
                    <DataTable.Column label="类型" name="type" width="20%"
                                      show={fieldsToShow.indexOf('Type') >= 0}/>
                    <DataTable.Column label="模板" name="blueprint_id" width="10%"
                                      show={fieldsToShow.indexOf('Blueprint') >= 0 && _.isEmpty(this.props.data.blueprintId)} />
                    <DataTable.Column label="部署" name="deployment_id" width="10%"
                                      show={fieldsToShow.indexOf('Deployment') >= 0 && _.isEmpty(this.props.data.deploymentId)} />
                    <DataTable.Column label="包含在" name="host_id" width="7%"
                                      show={fieldsToShow.indexOf('Contained in') >= 0}/>
                    <DataTable.Column label="连接" width="7%"
                                      show={fieldsToShow.indexOf('Connected to') >= 0}/>
                    <DataTable.Column label="主机" name='host_id' width="7%"
                                      show={fieldsToShow.indexOf('Host') >= 0}/>
                    <DataTable.Column label="创造者" name='created_by' width="7%"
                                      show={fieldsToShow.indexOf('Creator') >= 0}/>
                    <DataTable.Column label="# 实例" name="number_of_instances" width="9%"
                                      show={fieldsToShow.indexOf('# Instances') >= 0}/>
                    <DataTable.Column label="组" width="10%"
