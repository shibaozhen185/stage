        ...
        return (
            <div>
                ...
                <DataTable className="nodesInstancesTable">
                    ...
                    <DataTable.Column label="实例" name="id" width="40%"/>
                    <DataTable.Column label="状态" name="state" width="30%"/>
                    <DataTable.Column label="详情" name="details" width="30%"/>
                    {
                            ...
                            return (
                                <DataTable.Row key={instance.id} selected={instance.isSelected} onClick={this._selectNodeInstance.bind(this, instance)}>
                                    ...
                                    <DataTable.Data className="center aligned rowActions">
                                        ...
                                        {/*onClick={this._showInstanceModal(instance)}*/}
                                    </DataTable.Data>
                                </DataTable.Row>
                            );
                        })
