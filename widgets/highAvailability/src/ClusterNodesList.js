        ...
        return (
            <div>
                ...
                <DataTable fetchData={this.fetchData.bind(this)}
                    ...
                    <DataTable.Column label="主机IP" name="host_ip" width="20%"/>
                    <DataTable.Column label="初始化" name="initialized" width="10%"/>
                    <DataTable.Column label="是否主服务器" name="master" width="10%"/>
                    <DataTable.Column label="是否在线" name="online" width="10%"/>
