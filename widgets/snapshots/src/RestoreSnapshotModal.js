        ...
        return (
            <Modal open={this.props.open} onClose={()=>this.props.onHide()}>
                ...
                <Modal.Content>
                    <Form loading={this.state.loading} errors={this.state.errors}
...

                        {
                            ...
                            <Message>
                               当从一个没有租户的环境中恢复时，请确保将快照上传至 一个不包含任何其他资源的(clear)租户。
                            </Message>

                        }
                        <Form.Field>
                            <Form.Checkbox toggle
                                           label="强制修复即使管理不是空的(这会删除所有数据)"
                ...
                <Modal.Actions>
                    ...
                    <ApproveButton onClick={this.onApprove.bind(this)} disabled={this.state.loading} content="恢复" icon="undo" color="green"/>
                </Modal.Actions>
            </Modal>
        );
    }
