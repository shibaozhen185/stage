    ...
    render() {
        ...
        return (
            <Modal open={this.props.open} onClose={()=>this.props.onHide()} className="editTenantsModal">
                <Modal.Header>
                    <Icon name="user"/> 编辑租户 {user.username}
                </Modal.Header>
                ...
                <Modal.Content>
                    <Form loading={this.state.loading} errors={this.state.errors}
                        ...
                        <Form.Field>
                            <Form.Dropdown placeholder='租户' multiple selection options={options} name="tenants"
                ...
                <Modal.Actions>
                    ...
                    <ApproveButton onClick={this.onApprove.bind(this)} disabled={this.state.loading} icon="user" color="green" content="保存"/>
                </Modal.Actions>
            </Modal>
        );
    }
