        ...
        return (
            <div>
                ...
                <DataTable fetchData={this.fetchData.bind(this)}
                    ...
                    <DataTable.Column label="用户名" name="username" width="32%" />
                    <DataTable.Column label="最后一次登录" name="last_login_at" width="18%" />
                    <DataTable.Column label="系统角色" width="15%" />
                    <DataTable.Column label="活跃状态" name="active" width="10%" />
                    <DataTable.Column label="分组" width="10%" />
                    <DataTable.Column label="租户" width="10%" />
