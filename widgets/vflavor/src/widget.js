...
import VflavorTable from './VflavorTable';

Stage.defineWidget({
    id: 'vflavor',
    name: '主机资源管理',
    description: '显示VIM下云主机资源信息',
    initialWidth: 5,
    initialHeight: 16,
    color: 'blue',
    isReact: true,
    isAdmin: true,
    hasStyle: true,
    permission: Stage.GenericConfig.WIDGET_PERMISSION('vflavor'),
    ...
    fetchData: function fetchData(widget, toolbox, params) {
        ...
        return toolbox.getManager().doGet(url).then(function (data) {
            ...
            // let return_json = toolbox.getManager().getFlavors(pp);
            // result= return_json;
            // return result;
        // });
    },
    ...
    render: function(widget, data, error, toolbox) {
        ...
        return (
            <VflavorTable widget={widget} data={formattedData} toolbox={toolbox}/>
        );
