        ...
        return (
            <div>
                ...
                <DataTable fetchData={this.fetchGridData.bind(this)}
                    ...
                    <DataTable.Column label="时间戳" width="10%" show={fieldsToShow.indexOf('Timestamp') >= 0}/>
                    <DataTable.Column label="类型" show={fieldsToShow.indexOf('Type') >= 0}/>
                    <DataTable.Column label="模版" show={!this.props.data.blueprintId && !this.props.data.deploymentId &&
                                            !this.props.data.executionId && fieldsToShow.indexOf('Blueprint') >= 0} />
                    <DataTable.Column label="部署" show={!this.props.data.deploymentId && !this.props.data.executionId &&
                                            fieldsToShow.indexOf('Deployment') >= 0} />
                    <DataTable.Column label="工作流" show={!this.props.data.executionId && fieldsToShow.indexOf('Workflow') >= 0} />
                    <DataTable.Column label="操作" show={fieldsToShow.indexOf('Operation') >= 0}/>
                    <DataTable.Column label="节点名称" show={fieldsToShow.indexOf('Node Name') >= 0}/>
                    <DataTable.Column label="节点 Id" show={fieldsToShow.indexOf('Node Id') >= 0}/>
                    <DataTable.Column label="信息" show={fieldsToShow.indexOf('Message') >= 0}/>
