...
export default class CreateModal extends React.Component {
    ...
    render() {
        ...
        const addButton = <Button content='添加' icon='add user' labelPosition='left' />;
