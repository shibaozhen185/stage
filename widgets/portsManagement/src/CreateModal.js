...
export default class CreateModal extends React.Component {
    ...
    render() {
        ...
        const addButton = <Button content='添加端口组' icon='add' labelPosition='left' />;
