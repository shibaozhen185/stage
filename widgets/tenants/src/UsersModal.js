        ...
        <Modal open={this.props.open} onClose={()=>this.props.onHide()}>
            ...
            <Modal.Content>
                <Form loading={this.state.loading} errors={this.state.errors}
                    ...
                    <Form.Field>
                        <Form.Dropdown placeholder='用户' multiple selection options={users} name="users"
            ...
            <Modal.Actions>
                ...
                <ApproveButton onClick={this.onApprove.bind(this)} disabled={this.state.loading} content="保存" icon="user" color="green"/>
            </Modal.Actions>
        </Modal>
        );
    }
