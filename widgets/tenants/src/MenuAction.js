        ...
        return (
            <PopupMenu>
                <Menu pointing vertical>
                    <Menu.Item icon='user' content='编辑用户' name={MenuAction.EDIT_USERS_ACTION}
                               onClick={this._onDropdownChange.bind(this)}/>
                    <Menu.Item icon='users' content='编辑用户组' name={MenuAction.EDIT_USER_GROUPS_ACTION}
                               onClick={this._onDropdownChange.bind(this)}/>
                    <Menu.Item icon='trash' content='删除' name={MenuAction.DELETE_TENANT_ACTION}
                               onClick={this._onDropdownChange.bind(this)}/>
                </Menu>
            </PopupMenu>
        )
