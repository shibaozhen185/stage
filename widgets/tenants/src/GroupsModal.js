        ...
        <Modal open={this.props.open} onClose={()=>this.props.onHide()}>
            ...
            <Modal.Content>
                <Form loading={this.state.loading} errors={this.state.errors}
                    ...
                    <Form.Field>
                        <Form.Dropdown placeholder='用户组' multiple selection options={userGroups} name="userGroups"
            ...
            <Modal.Actions>
                ...
                <ApproveButton onClick={this.onApprove.bind(this)} disabled={this.state.loading} icon="users" color="green" content="保存"/>
            </Modal.Actions>
        </Modal>
        );
    }
